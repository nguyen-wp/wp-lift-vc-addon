...
vc_add_shortcode_param( 'lift_hidden_frm', 'lift_hidden_f' );

function lift_hidden_f( $settings, $value ) {
    
    return '<input name="' . $settings['param_name'] . '" class="lift_hidden_frm wpb_vc_param_value wpb-textinput ' . $settings['param_name'] . ' ' . $settings['type'] . '" type="hidden" value=""/>';

}
vc_add_shortcode_param( 'lift_disable_frm_id_gen', 'lift_disable_frm_id_gen' );

function lift_disable_frm_id_gen( $settings, $value ) {
    
    return '<input name="' . $settings['param_name'] . '" class="lift_disable_frm_id_gen wpb_vc_param_value wpb-textinput ' . $settings['param_name'] . ' ' . $settings['type'] . '" type="text" value="'.$value.'"/>';

}
vc_add_shortcode_param( 'lift_hidden_frm_button', 'lift_hidden_frm_button' );

function lift_hidden_frm_button( $settings, $value ) {
    
    return '<button name="' . $settings['param_name'] . '" class="lift_hidden_frm_button wpb_vc_param_value vc_general vc_ui-button-shape-rounded vc_ui-button vc_ui-button-action ' . $settings['param_name'] . ' ' . $settings['type'] . '" value="'.$value.'" type="button" />'.$value.'</button>';

}



add_filter( 'vc_iconpicker-type-iconsmind', 'lift_vc_iconpicker_type_iconsmind' );
/**
 * Add iconsmind icon family into page builder.
 *
 * @since 1.0
 */
function lift_vc_iconpicker_type_iconsmind( $icons ) {
...
add_filter( 'vc_iconpicker-type-steadysets', 'lift_vc_iconpicker_type_steadysets' );
 ...
 * @since 1.0
 */
function lift_vc_iconpicker_type_steadysets( $icons ) {
...
add_filter( 'vc_iconpicker-type-linea', 'lift_vc_iconpicker_type_linea' );
 ...
 * @since 1.0
 */
function lift_vc_iconpicker_type_linea( $icons ) {
	$linea_icons = array(
