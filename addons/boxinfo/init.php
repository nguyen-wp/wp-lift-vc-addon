...
if (!class_exists('liftVC_Addons_BoxInfo')) {
	...
	class liftVC_Addons_BoxInfo extends LIFT_Helpers
	{
		...
		public $name = 'boxinfo';
		public $pNicename = 'LIFT Magic Box';
			...
			return array(
				...
				'params'      => array(
					...
					array(
						...
						'edit_field_class' => 'vc_col-xs-12 lift-childcol-3',
						'group' => __('Format', 'js_composer')
					),
					array(
						'type' => 'colorpicker',
		...
		public function output($atts, $content = null)
		{
			...
			$theme = isset($atts["theme"]) ? ' lift-theme-'. $atts["theme"] : null;
			...
			$css_build .= $desc_color ? $cssname.' .lift-ctn .lift-content{color:'.$this->liftHexToRGB($desc_color).'!important}' : null;
			$css_build .= $applyDesc ? $cssname.' .lift-ctn .lift-content{'.$applyDesc.'!important}' : null;
			$css_build .= $applyHeadingStyle ? $cssname.' .lift-ctn .lift-title{'.$applyHeadingStyle.'!important}' : null;
			$css_build .= $applyHeadingStyle ? $cssname.' .lift-ctn .lift-title .lift-title-link{'.$applyHeadingStyle.'!important}' : null;
			$css_build .= $getGoogleFont ? $cssname.' {'.$getGoogleFont.'!important}' : null;
			$css_build .= $getGoogleFont ? $cssname.' .lift-ctn .lift-title{'.$getGoogleFont.'!important}' : null;
			$css_build .= $getGoogleFont ? $cssname.' .lift-ctn .lift-title{'.$getGoogleFont.'!important}' : null;
			$css_build .= $icon_size ? $cssname.' .lift-ctn .lift-icon{'.$applyIconStyle.'!important}' : null;
			// BUTTON 
			$css_build .= $btn_color ? ''. $cssname.' .lift-button >*{color:'.$this->liftHexToRGB($btn_color).'!important}' : null;
			$css_build .= $btn_bg ? ''. $cssname.' .lift-button >*{background-color:'.$this->liftHexToRGB($btn_bg,$btn_transparent).'!important}' : null;
			$css_build .= $btn_border_color ? ''. $cssname.' .lift-button >*{border-color:'.$this->liftHexToRGB($btn_border_color).'!important}' : null;
			$css_build .= $btn_border ? ''. $cssname.' .lift-button >*{border-style:solid!important;border-width:'.$btn_border.'!important;}' : null;
			if($btn_border_style) {
				if($btn_border_style === 'top') {
					$css_build .= ''. $cssname.' .lift-button >*{border-left-width:0!important;border-right-width:0!important;border-bottom-width:0!important}';
				} else if($btn_border_style === 'bottom') {
					$css_build .= ''. $cssname.' .lift-button >*{border-left-width:0!important;border-right-width:0!important;border-top-width:0!important}';
				} else if($btn_border_style === 'left') {
					$css_build .= ''. $cssname.' .lift-button >*{border-top-width:0!important;border-right-width:0!important;border-bottom-width:0!important}';
				} else if($btn_border_style === 'right') {
					$css_build .= ''. $cssname.' .lift-button >*{border-top-width:0!important;border-left-width:0!important;border-bottom-width:0!important}';
				}
			}
			$css_build .= $btn_border_radius ? ''. $cssname.' .lift-button >*{border-radius:'.$btn_border_radius.'!important;}' : null;
			$css_build .= $btn_padding ? ''. $cssname.' .lift-button >*{padding:'.$btn_padding.'!important;}' : null;
			$css_build .= $btn_margin ? ''. $cssname.' .lift-button >*{margin:'.$btn_margin.'!important;}' : null;
			$css_build .= ($btn_decoration && $btn_decoration === 'yes') ? ''. $cssname.' .lift-button >*{text-decoration: none!important;}' : null;
			$css_build .= $icon_color ? ''. $cssname.' .lift-icon {color:'.$this->liftHexToRGB($icon_color).'!important}' : null;

			if($add_box_button){
				$css_build .= $btn_hover_color ? ''. $cssname.':hover .lift-button >*{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
				$css_build .= $btn_hover_color ? ''. $cssname.':focus .lift-button >*{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
				$css_build .= $btn_hover_color ? ''. $cssname.':active .lift-button >*{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.':hover .lift-button >*{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.':focus .lift-button >*{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.':active .lift-button >*{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.':hover .lift-button >*{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.':focus .lift-button >*{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.':active .lift-button >*{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
				$css_build .= $icon_color_hover ? ''. $cssname.':hover .lift-icon {color:'.$this->liftHexToRGB($icon_color_hover).'!important}' : null;
				$css_build .= $icon_color_hover ? ''. $cssname.':focus .lift-icon {color:'.$this->liftHexToRGB($icon_color_hover).'!important}' : null;
				$css_build .= $icon_color_hover ? ''. $cssname.':active .lift-icon {color:'.$this->liftHexToRGB($icon_color_hover).'!important}' : null;
			} else {
				$css_build .= $btn_hover_color ? ''. $cssname.' .lift-button >*:hover{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
				$css_build .= $btn_hover_color ? ''. $cssname.' .lift-button >*:focus{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
				$css_build .= $btn_hover_color ? ''. $cssname.' .lift-button >*:active{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-button >*:hover{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-button >*:focus{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-button >*:active{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.' .lift-button >*:hover{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.' .lift-button >*:focus{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.' .lift-button >*:active{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
				$css_build .= $icon_color_hover ? ''. $cssname.' .lift-icon:hover {color:'.$this->liftHexToRGB($icon_color_hover).'!important}' : null;
				$css_build .= $icon_color_hover ? ''. $cssname.' .lift-icon:focus {color:'.$this->liftHexToRGB($icon_color_hover).'!important}' : null;
				$css_build .= $icon_color_hover ? ''. $cssname.' .lift-icon:active {color:'.$this->liftHexToRGB($icon_color_hover).'!important}' : null;
			}

			$css_build .= $text_color_hover ? ''. $cssname.':hover .lift-ctn .lift-title{color:'.$this->liftHexToRGB($text_color_hover).'!important;}' : null;
			$css_build .= $text_color_hover ? ''. $cssname.':hover .lift-ctn .lift-title .lift-title-link{color:'.$this->liftHexToRGB($text_color_hover).'!important;}' : null;
			$css_build .= $desc_color_hover ? ''. $cssname.':hover .lift-ctn .lift-content{color:'.$this->liftHexToRGB($desc_color_hover).'!important;}' : null;
			...
			$css_build .= $box_bg ? ''. $cssname.' .box-bg {background-color:'.$this->liftHexToRGB($box_bg).'!important;}' : null;
			$css_build .= $box_hover_bg ? ''. $cssname.':hover .box-bg {background-color:'.$this->liftHexToRGB($box_hover_bg).'!important;}' : null;
			$css_build .= $box_border_hover ? ''. $cssname.':hover {border-color:'.$this->liftHexToRGB($box_border_hover).'!important;}' : null;
			...
			$css_build .= $desc_transition_hover ? ''. $cssname.' .lift-ctn .lift-content{transition:all ease-in-out '.$desc_transition_hover.'!important;}' : null;
			$css_build .= $transition_hover ? ''. $cssname.' .lift-ctn .lift-title{transition:all ease-in-out '.$transition_hover.'!important;}' : null;
			$css_build .= $transition_hover ? ''. $cssname.' .lift-ctn .lift-title .lift-title-link{transition:all ease-in-out '.$transition_hover.'!important;}' : null;
			...
			$css_build .= $text_padding ? ''. $cssname.' .lift-ctn .lift-title{padding:'.$text_padding.'!important;}' : null;
			$css_build .= $text_margin ? ''. $cssname.' .lift-ctn .lift-title{margin:'.$text_margin.'!important;}' : null;
			$css_build .= $desc_padding ? ''. $cssname.' .lift-ctn .lift-content{padding:'.$desc_padding.'!important;}' : null;
			$css_build .= $desc_margin ? ''. $cssname.' .lift-ctn .lift-content{margin:'.$desc_margin.'!important;}' : null;
