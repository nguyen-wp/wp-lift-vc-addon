...
if (!class_exists('liftVC_Addons_Popup')) {
	...
	class liftVC_Addons_Popup extends LIFT_Helpers
	{
		...
		public function output($atts, $content = null)
		{
			...
			// BUTTON 
			$css_build .= $btn_color ? ''. $cssname.' .lift-title-link{color:'.$this->liftHexToRGB($btn_color,$btn_text_transparent).'!important}' : null;
			$css_build .= $btn_bg ? ''. $cssname.' .lift-title-link{background-color:'.$this->liftHexToRGB($btn_bg,$btn_transparent).'!important}' : null;
			$css_build .= $btn_border_color ? ''. $cssname.' .lift-title-link{border-color:'.$this->liftHexToRGB($btn_border_color).'!important}' : null;
			$css_build .= $btn_border ? ''. $cssname.' .lift-title-link{border-style:solid!important;border-width:'.$btn_border.'!important;}' : null;
			if($btn_border_style) {
				if($btn_border_style === 'top') {
					$css_build .= ''. $cssname.' .lift-title-link{border-left-width:0!important;border-right-width:0!important;border-bottom-width:0!important}';
				} else if($btn_border_style === 'bottom') {
					$css_build .= ''. $cssname.' .lift-title-link{border-left-width:0!important;border-right-width:0!important;border-top-width:0!important}';
				} else if($btn_border_style === 'left') {
					$css_build .= ''. $cssname.' .lift-title-link{border-top-width:0!important;border-right-width:0!important;border-bottom-width:0!important}';
				} else if($btn_border_style === 'right') {
					$css_build .= ''. $cssname.' .lift-title-link{border-top-width:0!important;border-left-width:0!important;border-bottom-width:0!important}';
				}
			}
			$css_build .= $btn_border_radius ? ''. $cssname.' .lift-title-link{border-radius:'.$btn_border_radius.'!important;}' : null;
			$css_build .= $btn_padding ? ''. $cssname.' .lift-title-link{padding:'.$btn_padding.'!important;}' : null;
			$css_build .= $btn_margin ? ''. $cssname.' .lift-title-link{margin:'.$btn_margin.'!important;}' : null;
			$css_build .= ($btn_decoration && $btn_decoration === 'yes') ? ''. $cssname.' .lift-title-link{text-decoration: none!important;}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .lift-title-link:hover{color:'.$this->liftHexToRGB($btn_hover_color,$btn_text_transparent_hover).'!important}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .lift-title-link:focus{color:'.$this->liftHexToRGB($btn_hover_color,$btn_text_transparent_hover).'!important}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .lift-title-link:active{color:'.$this->liftHexToRGB($btn_hover_color,$btn_text_transparent_hover).'!important}' : null;
			$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-title-link:hover{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
			$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-title-link:focus{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
			$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-title-link:active{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .lift-title-link:hover{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .lift-title-link:focus{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .lift-title-link:active{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
			$css_build .= $btn_line_height ? ''. $cssname.' .lift-title-link{line-height:'.$btn_line_height.'!important;}' : null;
			...
			$output .= '<section'. $block_id .' class="lift-elements lift-' . $this->name. $classname.' lift_'.$randomNumClass.'"' . str_replace('``', '', $attribute) . '>';
