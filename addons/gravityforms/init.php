...
if (!class_exists('liftVC_Addons_GravityForms')) {
	...
	class liftVC_Addons_GravityForms extends LIFT_Helpers
	{
		...
		public function output($atts, $content = null)
		{
			...
			$cssaddclass = $atts['css'] ? vc_shortcode_custom_css_class($css, ' ') : ' lift_'.$randomNumClass;
			
			$css_build = '';
			$css_build .= $text_color ? $cssname.' .gform_wrapper{color:'.$this->liftHexToRGB($text_color).'!important}' : null;
			$css_build .= $link_color ? $cssname.' .gform_wrapper a{color:'.$this->liftHexToRGB($link_color).'!important}' : null;
			$css_build .= $link_hover_color ? $cssname.' .gform_wrapper a:hover{color:'.$this->liftHexToRGB($link_hover_color).'!important}' : null;
			$css_build .= $input_color ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{color:'.$this->liftHexToRGB($input_color).'!important}' : null;
			$css_build .= $input_hover_color ? ''. $cssname.' .gform_wrapper input:hover, '. $cssname.' .gform_wrapper select:hover, '. $cssname.' .gform_wrapper textarea:hover{color:'.$this->liftHexToRGB($input_hover_color).'!important}' : null;
			$css_build .= $input_hover_color ? ''. $cssname.' .gform_wrapper input:focus, '. $cssname.' .gform_wrapper select:focus, '. $cssname.' .gform_wrapper textarea:focus{color:'.$this->liftHexToRGB($input_hover_color).'!important}' : null;
			$css_build .= $input_hover_color ? ''. $cssname.' .gform_wrapper input:active, '. $cssname.' .gform_wrapper select:active, '. $cssname.' .gform_wrapper textarea:active{color:'.$this->liftHexToRGB($input_hover_color).'!important}' : null;
			$css_build .= $input_bg ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{background-color:'.$this->liftHexToRGB($input_bg,$input_transparent).'!important}' : null;
			$css_build .= $input_hover_bg ? ''. $cssname.' .gform_wrapper input:hover, '. $cssname.' .gform_wrapper select:hover, '. $cssname.' .gform_wrapper textarea:hover{background-color:'.$this->liftHexToRGB($input_hover_bg,$input_transparent_hover).'!important}' : null;
			$css_build .= $input_hover_bg ? ''. $cssname.' .gform_wrapper input:focus, '. $cssname.' .gform_wrapper select:focus, '. $cssname.' .gform_wrapper textarea:focus{background-color:'.$this->liftHexToRGB($input_hover_bg,$input_transparent_hover).'!important}' : null;
			$css_build .= $input_hover_bg ? ''. $cssname.' .gform_wrapper input:active, '. $cssname.' .gform_wrapper select:active, '. $cssname.' .gform_wrapper textarea:active{background-color:'.$this->liftHexToRGB($input_hover_bg,$input_transparent_hover).'!important}' : null;
			$css_build .= $input_border_color ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{border-color:'.$this->liftHexToRGB($input_border_color).'!important}' : null;
			$css_build .= $input_border_hover ? ''. $cssname.' .gform_wrapper input:hover, '. $cssname.' .gform_wrapper select:hover, '. $cssname.' .gform_wrapper textarea:hover{border-color:'.$this->liftHexToRGB($input_border_hover).'!important}' : null;
			$css_build .= $input_border_hover ? ''. $cssname.' .gform_wrapper input:focus, '. $cssname.' .gform_wrapper select:focus, '. $cssname.' .gform_wrapper textarea:focus{border-color:'.$this->liftHexToRGB($input_border_hover).'!important}' : null;
			$css_build .= $input_border_hover ? ''. $cssname.' .gform_wrapper input:active, '. $cssname.' .gform_wrapper select:active, '. $cssname.' .gform_wrapper textarea:active{border-color:'.$this->liftHexToRGB($input_border_hover).'!important}' : null;
			...
			$css_build .= $btn_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]{color:'.$this->liftHexToRGB($btn_color).'!important;}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:hover{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:focus{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:active{color:'.$this->liftHexToRGB($btn_hover_color).'!important}' : null;
			$css_build .= $btn_bg ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]{background-color:'.$this->liftHexToRGB($btn_bg,$btn_transparent).'!important}' : null;
			$css_build .= $btn_border_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]{border-color:'.$this->liftHexToRGB($btn_border_color).'!important}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:hover{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:focus{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:active{border-color:'.$this->liftHexToRGB($btn_border_hover).'!important}' : null;
			...
			$css_build .= $btn_hover_bg ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:hover{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
			$css_build .= $btn_hover_bg ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:focus{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
			$css_build .= $btn_hover_bg ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:active{background-color:'.$this->liftHexToRGB($btn_hover_bg,$btn_transparent_hover).'!important}' : null;
