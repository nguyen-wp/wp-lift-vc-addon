...
<a href="'.$image_src_full.'" data-fancybox="gallery_'.trim($cssaddclass).'" data-caption="'.wp_get_attachment_caption($img_single).'"><img class="img-with-animation-lift skip-lazy '.esc_attr($img_class).'" '.$image_attrs_escaped.' />
<figcaption></figcaption>
</a></figure>';

$arImgG = explode(",",$img_group);
$output .= '<ul class="lift-img-group" style="display:none">';
