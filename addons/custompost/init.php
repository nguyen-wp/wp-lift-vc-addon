...
if (!class_exists('liftVC_Addons_CustomPost')) {
	...
	class liftVC_Addons_CustomPost extends LIFT_Helpers
	{
				...
				'params'      => array(
					...
					array(
						...
						'value' => array(
							...
							esc_html__( 'Display 7 (fs-1)', 'js_composer' ) => 'fs-1',
							esc_html__( 'Display 8 (fs-2)', 'js_composer' ) => 'fs-2',
							esc_html__( 'Display 9 (fs-3)', 'js_composer' ) => 'fs-3',
							esc_html__( 'Display 10 (fs-4)', 'js_composer' ) => 'fs-4',
							esc_html__( 'Display 11 (fs-5)', 'js_composer' ) => 'fs-5',
							esc_html__( 'Display 12 (fs-6)', 'js_composer' ) => 'fs-6',
						),
		...
		public function output($atts, $content = null)
		{
			...
			$links_layout = $atts["links_layout"] ? ' '. $atts["links_layout"] : ' text-left';
